...
ID3D11SamplerState *D3D11Helpers::GetResourceSamplerState(GPUResource *pResource)
{
    ...
    case GPU_RESOURCE_TYPE_SAMPLER_STATE:
        return static_cast<D3D11GPUSamplerState *>(pResource)->GetD3DSamplerState();
...
ID3D11UnorderedAccessView* D3D11Helpers::GetResourceUnorderedAccessView(GPUResource *pResource)
{
    if (pResource == nullptr)
        return nullptr;
